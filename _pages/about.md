...
- 目前产线 AI 参与率达80%+，产出内容质量达主流网文平台 Top 20%。

### 2024.5 - 至今 AI 短篇网文创作 负责人 
背景：在当前内容消费趋向短篇化和碎片化的市场环境下，探索利用 AI 进行短篇网文的快速创作与精准投放。尝试开拓拉新用户、内容付费和版权收入等多元化商业模式。
- 针对短篇网文市场现状，快速制定出改编创作的方案。在1个月内独立探索出古改今、性转等创作形式。并实现了创作流程的工程化，1-3w 字短篇的生产在1h 内完成。
- 协同用户增长团队，探索拉新的应用场景，已供稿xx篇，衍生内容拉新xxx。
- 推进自产的短篇小说音频在站内的投放，和用户心智的培养，已供稿xx篇，板块DAU xxx。
- 验证自产短篇小说在渠道的投放，形成周期数据反馈，不断打磨选题和内容质量，同时取得版权收入xxx。
